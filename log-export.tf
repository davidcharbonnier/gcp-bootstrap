...
module "log-export-dataset" {
  source        = "git@github.com:GoogleCloudPlatform/cloud-foundation-fabric.git//modules/bigquery-dataset?ref=v23.0.0"
...
module "log-export-logbucket" {
  source      = "git@github.com:GoogleCloudPlatform/cloud-foundation-fabric.git//modules/logging-bucket?ref=v23.0.0"
...
module "log-export-pubsub" {
  source     = "git@github.com:GoogleCloudPlatform/cloud-foundation-fabric.git//modules/pubsub?ref=v23.0.0"
